    ...
    <div class="dialog-box">
        ...
        <div class="dialog-right">
          <el-form class="form" :model="formData" ref="form" :rules="rules" label-width="80px">
            ...
            <el-form-item v-if="false" label="缩略图" prop="headerImgUrl">
              <div @click="upload(0)">
                <el-upload
            ...
            <div class="form-content">
              <el-form-item id="content" label="内容" prop="content">
                <el-input v-model="inputContentValue" type="textarea" rows="4" maxlength="120" show-word-limit autocomplete="off"></el-input>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    _getList() {
      ...
      this.$http
        .get('/v1/MiniWebsiteEducationIdea/getList', param)
        .then((res) => {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          if (!this.formData.id) { // 新增数据
            this.$http
              .post('/v1/MiniWebsiteEducationIdea/addMiniWebsiteEducationIdea', param)
              .then((res) => {
                this.$message({
                  message: '添加成功',
                  type: 'success'
            ...
            this.$http
              .put('/v1/MiniWebsiteEducationIdea/updateMiniWebsiteEducationIdea', param)
              .then((res) => {
                this.$message({
                  message: '更新成功',
                  type: 'success'
